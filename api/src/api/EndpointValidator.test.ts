...
describe('EndpointValidator', () => {
    describe('getEndpointAndPathParams', () => {
        ...
        it.each([
            ...
            'returns endpoint and empty params object if direct path match (%s:%s)',
            (method, path) => {
        ...
        it.each([
            [
                'post',
                '/path/to/something/var',
                'post:/path/to/something/{param1}',
                { param1: 'var' },
            ],
            [
                'post',
                '/another/path/1/boo/2',
                'post:/another/path/{param1}/boo/{param2}',
                { param1: '1', param2: '2' },
            ],
            ['post', '/another/path/1/boo/', 'post:/another/path/{param1}/boo', { param1: '1' }],
        ])(
            'returns endpoint and populated params object if matches a parameterised path (%s:%s)',
            (method, path, expectedEndpoint, expectedParams) => {
        ...
        it('throws NotFoundError if no matches are found', () => {
            expect(() =>
                validator.getEndpointAndPathParams('post', '/another/path/1/boo/3/d'),
    ...
    describe('validateEndpoint', () => {
        it('throws NotFoundError if the endpoint to be validated does not exist in the specification', () => {
            ...
            expect(() => validator.validateEndpoint('get:/some/path', {})).toThrow(
                new NotFoundError('get:/some/path not found'),
            );
        });
        ...
        describe('fails validation when', () => {
            it.each([
                ...
                const validator = new EndpointValidator({
                    'put:/some/path': { requestBodyRequired: true, requestBodySchema },
                });
            ...
            it('path, query and requestBody objects exist but have no validation schema', () => {
                ...
                expect(errors).toContainEqual({
                    property: 'requestBody',
                    error: 'unexpected requestBody',
                });
                expect(errors).toContainEqual({
                    property: 'pathParams',
                    error: 'unexpected pathParams',
                });
                expect(errors).toContainEqual({
                    property: 'queryParams',
                    error: 'unexpected queryParams',
                });
            });
            ...
            describe('an object to be validated', () => {
                ...
                it('is not an object', () => {
                    ...
                    expect(errors).toContainEqual({
                        property: 'requestBody',
                        error: 'invalid data type - object expected',
                    });
                });
                ...
                it('has a required field that is not present', () => {
                    ...
                    const errors = validator.validateEndpoint('put:/some/path', {
                        requestBody: { field1: 'something' },
                    } as any);

                    expect(errors).toContainEqual({
                        property: 'requestBody.field2',
                        error: 'required field is not present',
                    });
                });
                ...
                it('does not allow additional properties but one is present in the object', () => {
                    ...
                    expect(errors).toContainEqual({
                        property: 'requestBody.fieldX',
                        error: 'field is not permitted',
                    });
                });
                ...
                describe('expects a field to be a string', () => {
                        ...
                        const requestBodySchema = {
                            ...
                            properties: {
                                ...
                                field2: {
                                    type: 'string',
                                    enum: ['X', 'Y'],
                                    fullPath: 'requestBody.field2',
                                },
                            },
                        } as any;

                        validator = new EndpointValidator({
                            'put:/some/path': { requestBodySchema },
                        });
                    });
                    ...
                    it('that is not a string', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1',
                            error: 'invalid data type - string expected',
                        });
                    });
                    ...
                    it('that is not one of the defined enum values', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field2',
                            error: 'value must be one of [X,Y]',
                        });
                    });
                    ...
                    it('that has a length below the defined minimum', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1',
                            error: 'invalid length - expected at least 2 characters',
                        });
                    });
                });
                ...
                describe('expects a field to be an integer', () => {
                    ...
                    it('that is not a number', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1',
                            error: 'invalid data type - integer expected',
                        });
                    });
                    ...
                    it('that has a value lower than the defined minimum', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field2',
                            error: 'integer must not be less than 10',
                        });
                    });
                    ...
                    it('that has a value greater than the defined maximum', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field2',
                            error: 'integer must not be more than 20',
                        });
                    });
                });
                ...
                describe('expects a field to be an object (some examples)', () => {
                            ...
                            properties: {
                                field1: {
                                    ...
                                    properties: {
                                        field2: {
                                            type: 'integer',
                                            fullPath: 'requestBody.field1.field2',
                                        },
                                    },
                                },
                            },
                    ...
                    it('that expects an integer field that is not a number', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1.field2',
                            error: 'invalid data type - integer expected',
                        });
                    });
                });
                ...
                describe('expects a field to be a pipe-delimited-string array', () => {
                            ...
                            properties: {
                                field1: {
                                    ...
                                    itemSchema: {
                                        type: 'integer',
                                        nullable: false,
                                        fullPath: 'requestBody.field1.items',
                                    },
                                },
                            },
                        } as any;
                    ...
                    it('is not a string', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1',
                            error: 'invalid data type - pipe-delimited array expected',
                        });
                    });
                ...
                describe('expects a field to be a non-pipe-delimited-string array', () => {
                            ...
                            properties: {
                                ...
                                field2: {
                                    ...
                                    itemSchema: {
                                        type: 'integer',
                                        nullable: false,
                                        fullPath: 'requestBody.field2.items',
                                    },
                                },
                            },
                        } as any;
                    ...
                    it.each([
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field1',
                            error: 'invalid data type - array expected',
                        });
                    });
                    ...
                    it('that has fewer elements than the defined minimum length (plural)', () => {
                        ...
                        expect(errors).toContainEqual({
                            property: 'requestBody.field2',
                            error: 'array must contain at least 2 items',
                        });
                    });
                });
            });
        ...
        describe('passes validation (returns no errors) when', () => {
                ...
                const requestBodySchema = {
                    ...
                    properties: {
                        field1: {
                            ...
                            additionalProperties: false,
                            properties: {
                                field2: { type: 'integer', fullPath: 'requestBody.field1.field2' },
                            },
                        },
                        field3: {
                            type: 'object',
                            ...
                            additionalProperties: false,
                            properties: {
                                field2: { type: 'integer', fullPath: 'requestBody.field3.field4' },
                            },
                        },
                        field5: {
                            type: 'object',
                            nullable: true,
                            fullPath: 'requestBody.field5',
                            additionalProperties: false,
                            properties: {
                                field2: { type: 'integer', fullPath: 'requestBody.field5.field6' },
                            },
                        },
                    },
                } as any;
                    ...
                    properties: {
                        ...
                        field3: {
                            ...
                            itemSchema: {
                                type: 'integer',
                                nullable: false,
                                fullPath: 'requestBody.field3.items',
                            },
                        },
                    },
                } as any;
            ...
            it('valid strings are provided in the path and query params', () => {
                ...
                const validator = new EndpointValidator({
                    'put:/some/path': { pathParamsSchema, queryParamsSchema },
                });
                const pathParams = {
                    field1: 'St',
                    field2: 'X',
                ...
                const pathParamsSchema = {
                    ...
                    properties: {
                        ...
                        field2: {
                            ...
                            minimum: 10,
                            maximum: 20,
                            fullPath: 'params.field2',
                        },
                    },
                } as any;
                const queryParamsSchema = pathParamsSchema;
                const validator = new EndpointValidator({
                    'put:/some/path': { queryParamsSchema, pathParamsSchema },
                });
                const pathParams = {
                    field1: '1234',
                    field2: '10',
            ...
            it('valid pipe-delimited array is provided in the query params', () => {
                ...
                const validator = new EndpointValidator({
                    'put:/some/path': { queryParamsSchema },
                });
                const queryParams = {
                    field1: '1|2|3',
                };
